...
//         if (treatmentMatch) formHandler('treatment', treatmentMatch[1].trim())
//         if (complainMatch) formHandler('primaryComplain', complainMatch[2].trim())
//     }
...
//         mediaRecorder.ondataavailable = (e) => {
//             console.log("ondataavailable CHAL GAYA!");
//             console.log("Data size:", e.data, "bytes");
//             if (e.data.size > 0) chunksRef.current.push(e.data)
//         }
...
//     useEffect(() => { setTranscript('') }, [resetTrigger])
...
//                 <div className="flex flex-col">
//                     <span className="text-sm font-semibold text-gray-700">
//                         {isProcessing ? 'Processing...' : isRecording ? 'Recording... (press to stop)' : 'Voice Entry'}
//                     </span>
//                     <span className="text-xs text-gray-400">
//                         Press mic, speak, press again to transcribe
//                     </span>
//                 </div>
//             </div>
