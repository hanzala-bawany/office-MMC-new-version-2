...
const StopModal = ({ isOpen, onClose , loginUserData , currentPatientsData , formData , docPatientData , setFormData }) => {
    ...
    const breakHandler = async () => {        
        ...
        try {
          ...
          toast.success(`Patients Stopped Susseccful`);
        ...
        >
            ...
            <div className="mb-5 p-3 bg-red-50 rounded-xl border border-red-200 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-red-600 mt-0.5">This action cannot be undone. Your message will replace the patient data on screen.</p>
                </div>
            </div>
            ...
            <div className="mb-5">
                ...
                <p className="text-xs text-gray-400 mt-1.5">
                    This message will be recorded and visible to Patients
                </p>
            </div>
