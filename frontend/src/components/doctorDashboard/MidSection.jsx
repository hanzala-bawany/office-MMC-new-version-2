...
const MidSection = ({ patientsData, docPatientData }) => {
  ...
  let patientToken = Number(
    specificSearchingToken?.split(" ")[0]?.split("-")[1],
  );
  ...
  const isPatientApointmentEqualstoChecked =
    patientsData?.todayAppointments == patientsData?.patientsChecked;
  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-6 xl:grid-cols-2 xl:gap-6 2xl:grid-cols-3 mb-8 h-auto xl:grid-rows-1">
      ...
      <div className="hidden xl:flex 2xl:hidden order-3 xl:order-3 themeBoxShadow border-none outline-none rounded-[10px] z-10 bg-white flex-col justify-between max-h-[55vh]">
      ...
      <div className="z-10 rounded-t-[12px] order-1 2xl:contents xl:row-span-2">
        {/* Patient Vitals */}
        <div className="z-10 themeBoxShadow rounded-t-[12px] rounded-b-none 2xl:rounded-[12px] bg-white flex flex-col justify-between transition-all duration-300 hover:shadow-lg 2xl:order-2">
          <div className="flex-1 p-4 flex items-center justify-between border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-blue-500 2xl:bg-none 2xl:from-transparent 2xl:to-transparent">
