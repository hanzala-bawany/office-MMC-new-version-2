...
const OPDReceipt = () => {
    ...
    const { data: consultantsData, loading: consultantsLoading, error: consultantsError } =
        useFetch(opdCategoryId ? '/api/receptionist/allConsultant' : null, { facultyId: opdCategoryId });
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    ...
                                    >
                                        <Select
                                            ...
                                            showSearch
                                            allowClear
                                            className="rounded-lg vertical-tags-select"
                                            suffixIcon={<span className="text-gray-400">▼</span>}
                        ...
                        <div className="grid grid-cols-5 gap-2">
                            ...
                            >
                                <Input
                                    ...
                                    suffix={<span className="text-xs text-blue-500 font-medium">PKR</span>}
                                />
                            </Form.Item>
                            ...
                            >
                                <Input
                                    ...
                                    allowClear
                                    prefix={<span className="text-gray-400 text-xs">Rs.</span>}
                                    suffix={<span className="text-xs text-green-500 font-medium">PKR</span>}
                                />
                            </Form.Item>
...
//     // console.log(referenceData, "referenceData ..............");mene apna form tumhe de dia he
...
//     useEffect(() => form.setFieldsValue({ grossPayment :grossAmount} )  ,  [grossAmount] )
