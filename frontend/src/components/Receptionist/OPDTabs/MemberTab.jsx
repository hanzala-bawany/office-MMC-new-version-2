...
const MemberTab = () => {
    ...
    return (
            ...
            title={
                <div className="flex items-center justify-between flex-wrap gap-2">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-lg font-semibold text-gray-800">Member Reception</span>
                        <span className="px-2 py-0.5 bg-teal-100 text-teal-700 text-xs font-medium rounded-full">Counter</span>
                    </div>
        ...
        >
            <Form form={form} layout="vertical" initialValues={{ date: moment(), gender: 'male' }}>

                {/* TOP: LEFT = Member & Consultant Info | RIGHT = Patient (Dependent) Details */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <Divider orientation="left" className="text-xs font-semibold text-gray-600 !my-1.5">
                            <span className="flex items-center gap-2">
                                <span className="w-1 h-4 bg-gradient-to-b from-teal-400 to-cyan-500 rounded-full"></span>
                                Member & Consultant Info
                            </span>
                        </Divider>
                        <div className="grid grid-cols-2 gap-3">
                            <Form.Item name="members" label={<span className="text-xs font-semibold text-gray-600">Member #</span>} rules={[{ required: true }]} className="col-span-2">
                                <Select
                                ...
                                >
                                    <Option value="m1">Ali Raza</Option>
                                    <Option value="m2">Fatima Khan</Option>
                                </Select>
                            </Form.Item>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Form.Item name="patientName" label={<span className="text-xs font-semibold text-gray-600">Dependent Name</span>} rules={[{ required: true }]} className="col-span-2">
                                <Select placeholder="Select Dependent" allowClear showSearch suffixIcon={<span className="text-gray-400">▼</span>} disabled={!selectedMember}>
                                    <Option value="d1">Ahmed Raza</Option>
                                    <Option value="d2">Ayesha Raza</Option>
                                </Select>
                            </Form.Item>
