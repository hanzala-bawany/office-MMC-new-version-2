...
const ageTypeOptions = ["Year", "Month", "Day"];
    ...
    return (
            ...
            title={
                <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-lg font-semibold text-gray-800">General OPD Reception</span>
                        <span className="px-2 py-0.5 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">Counter</span>
                    </div>
        ...
        >
            <Form
                form={form}
                layout="vertical"
                initialValues={{ date: moment(), patientTitle: 'Mr.', gender: 'male', ageType: 'Year' }}
                style={{ height: "100vh" }}
            ...
            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <Form.Item name="opdCategory" label={<span className="text-xs font-semibold text-gray-600">OPD Category</span>} rules={[{ required: true }]}>
                                    <Select placeholder="Select OPD Category" allowClear showSearch suffixIcon={<span className="text-gray-400">▼</span>}>
                                ...
                                <Form.Item name="reference" label={<span className="text-xs font-semibold text-gray-600">Reference</span>}>
                                    <Select placeholder="Select Reference" allowClear suffixIcon={<span className="text-gray-400">▼</span>}>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4  gap-4">
                                ...
                                <Form.Item label={<span className="text-xs font-semibold text-gray-600">Age</span>} required>
                                    <div className="grid grid-cols-2 gap-2">
                                        <Form.Item name="ageValue" rules={[{ required: true }]} noStyle>
                                            <InputNumber placeholder="Age" className="w-full!" min={0} allowClear />
                                        </Form.Item>
                                        <Form.Item name="ageType" noStyle>
                                            <Select className="w-full!" allowClear suffixIcon={<span className="text-gray-400">▼</span>}>
                                                {ageTypeOptions.map(a => <Option key={a} value={a}>{a}</Option>)}
                                            </Select>
                                        </Form.Item>
                                    </div>
                                </Form.Item>
                ...
                {/* Refund strip */}
                <div className="flex flex-wrap justify-between gap-3 mt-2 bg-gradient-to-r from-red-50/70 to-orange-50/70 p-2 rounded-xl border border-red-200/50">
